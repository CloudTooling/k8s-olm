...
| catalog.image.ref | string | `"quay.io/operator-framework/olm:v0.46.0"` |  |
...
| olm.image.ref | string | `"quay.io/operator-framework/olm:v0.46.0"` |  |
...
| package.image.ref | string | `"quay.io/operator-framework/olm:v0.46.0"` |  |

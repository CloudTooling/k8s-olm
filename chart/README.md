...
| catalog.image.ref | string | `"quay.io/operator-framework/olm:v0.41.0"` |  |
...
| olm.image.ref | string | `"quay.io/operator-framework/olm:v0.41.0"` |  |
...
| package.image.ref | string | `"quay.io/operator-framework/olm:v0.41.0"` |  |

...
| catalog.image.ref | string | `"quay.io/operator-framework/olm:v0.45.0"` |  |
...
| networkPolicy.dns.ports[2].port | int | `5353` |  |
| networkPolicy.dns.ports[2].protocol | string | `"TCP"` |  |
| networkPolicy.dns.ports[3].port | int | `5353` |  |
| networkPolicy.dns.ports[3].protocol | string | `"UDP"` |  |
| networkPolicy.kubeAPIServer | object | `{}` |  |
...
| olm.image.ref | string | `"quay.io/operator-framework/olm:v0.45.0"` |  |
...
| package.image.ref | string | `"quay.io/operator-framework/olm:v0.45.0"` |  |
